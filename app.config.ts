...
//   "TestProjectReportingKitCursorAgent"     → the real app name   (e.g. "MyApp")
//   "com.codeandtheory.testprojectreportingkitcursoragent" → the real package ID  (e.g. "com.example.myapp")
//   "testprojectreportingkitcursoragent"     → the lowercase slug   (e.g. "myapp")
// ──────────────────────────────────────────────────────────────────────────────
...
> = {
  development: {
    name: "TestProjectReportingKitCursorAgent Dev",
    androidPackage: "com.codeandtheory.testprojectreportingkitcursoragent.dev",
    iosBundleIdentifier: "com.codeandtheory.testprojectreportingkitcursoragent.dev",
  },
  staging: {
    name: "TestProjectReportingKitCursorAgent QA",
    androidPackage: "com.codeandtheory.testprojectreportingkitcursoragent.qa",
    iosBundleIdentifier: "com.codeandtheory.testprojectreportingkitcursoragent.qa",
  },
  production: {
    name: "TestProjectReportingKitCursorAgent",
    androidPackage: "com.codeandtheory.testprojectreportingkitcursoragent",
    iosBundleIdentifier: "com.codeandtheory.testprojectreportingkitcursoragent",
  },
};
...
export default ({ config }: ConfigContext): ExpoConfig => ({
  ...
  name: flavor.name,
  slug: "testprojectreportingkitcursoragent",
